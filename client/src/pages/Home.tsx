  ...
  return (
    ...
    >
        ...
        <div className={`w-full grid grid-cols-1 md:grid-cols-3 gap-8 mt-20`}>
          {isLoading ? (
            ...
            featuredPosts.map((post) => (
              <article
                key={post._id}
                className={`hover:shadow-lg rounded bg-white overflow-hidden group cursor-pointer flex flex-col text-black`}
      ...
      <div className='mt-10 px-2 py-8 flex justify-center flex-col align-items  w-full max-w-6xl'>
        ...
        <hr className='w-16 border-2 border-[#544cdb]' />
        <div className='w-full grid grid-cols-2 md:grid-cols-4 gap-8 mt-20 text-black'>
